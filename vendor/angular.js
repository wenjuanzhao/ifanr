 ...
 * {@link angular.Module}.
 *
 * An Angular **service** is a singleton object created by a **service service**.  These **service
 * factories** are functions which, in turn, are created by a **service provider**.
 * The **service providers** are constructor functions. When instantiated they must contain a
 * property called `$get`, which holds the **service service** function.
 *
 * When you request a service, the {@link auto.$injector $injector} is responsible for finding the
 * correct **service provider**, instantiating it and then calling its `$get` **service service**
 ...
 * * {@link auto.$provide#factory service(fn)} - registers a service **service function**, `fn`,
 ...
 * are constructor functions, whose instances are responsible for "providing" a service for a
 * service.
 *
 ...
 * @description
 *
 * Register a **service service**, which will be called to return the service instance.
 * This is short for registering a service where its provider consists of only a `$get` property,
 * which is the given service service function.
 * You should use {@link auto.$provide#factory $provide.service(getFn)} if you do not need to
...
var $AnimateProvider = ['$provide', function($provide) {
   ...
   *
   * @description
   * Registers a new injectable animation service function. The service function produces the
   ...
   * @param {Function} factory The service function that will be executed to return the animation
   *                           object.
   */
 ...
 * Dependency Injected. To achieve this a filter definition consists of a service function which is
 ...
 *     });
 *
 *     // register a filter service which uses the
